    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        /*leading: IconButton(onPressed: (){
          QuickHelp.goToNavigatorScreen(context, VideoAdsScreen());
          ...
          return ContainerCorner(
            ...
            child: Row(
              children: [
                ...
                Flexible(child: _getAllStories())
              ],
            ),
          );
        } else {
          bool showLstHeight = allPosts.length != 0;
          return ContainerCorner(
            width: size.width,
            borderWidth: 0,
            height: showLstHeight ? (allPosts.length * 485) : size.height,
            child: initQuery(false),
          );
        }
      },
    );
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (allPosts.isNotEmpty) {
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                final PostsModel post = allPosts[index];
                final UserModel? author;

                //debugPrint("sao_usuarois: ${post.getAuthor}");
                                  ...
                                  children: [
                                    Stack(
                                      ...
                                      children: [
                                        ...
                                        if (author.getAvatarFrame !=
                                            null &&
                                            author.getCanUseAvatarFrame!)
                                          ContainerCorner(
                                            borderWidth: 0,
                                            width: 55,
                                            height: 55,
                                            child: CachedNetworkImage(
                                              imageUrl: author.getAvatarFrame!.url!,
                                              imageBuilder:
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            if(author.getCountryCode!.isNotEmpty)
                                              Image.asset(
                                                QuickHelp.getCountryFlag(code: author.getCountryCode!),
                                                height: 12,
                                              )
                                          ],
                                        ),
